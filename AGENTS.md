...
| `bin/` | Commandline scripts, see [rockspec](statemachine-scm-1.rockspec) |
...
All code MUST be compatible with the Lua versions specified in the [rockspec](statemachine-scm-1.rockspec). This includes LuaJIT. Do not use features specific to a single Lua version without a compatibility shim.
